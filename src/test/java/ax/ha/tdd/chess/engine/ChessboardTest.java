...
public class ChessboardTest {
    ...
    public void fullboard_Queens_isInCorrectSpot() {
        ...
        Assertions.assertEquals(new Queen(PieceType.QUEEN, Player.BLACK,new Coordinates(4, 0)), chessboard.getPiece(new Coordinates(3, 0)));
        Assertions.assertEquals(new Queen(PieceType.QUEEN, Player.WHITE,new Coordinates(4, 7)), chessboard.getPiece(new Coordinates(3, 7)));
    }
}
